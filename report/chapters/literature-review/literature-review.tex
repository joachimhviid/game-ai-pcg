...
with Fitness Functions in game design, specifically analyzing how evolutionary computations
...
Procedural Content Generation (PCG) refers to the algorithm in games that creates game content with
...
already existing content like levels and amount of enemies \cite{PCG_ML}. This project tries to
