...
field thats been studied for a long time, but still not fully understood, because its a complex problem that involves a lot of different factors, including human factors.
...
We want to explore the use of genetic algorithms to generate dungeon layouts that are more engaging and fun to play, and with the use of AI, experience testing and 
project Minidungeons by Antonios Liapis \cite{liapis_minidungeons} we can hope to achiece a better understanding of the problem and be a part to 
help create more engaging and fun dungeon crawler games.
