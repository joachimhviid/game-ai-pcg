...
that are repetitive, easy or unfairly difficult. An example of this of this issue is observed in the roguelike game,
...
tries to prioritize player engagement together with player difficulty to create good flow. Building on the Minidungeons
...
stochastic generation methods.

\begin{itemize}
	\item H: If a genetic algorithm is configured to iteratively search for dungeon layouts that achieve a balance between 
	challenge and player skill, then the resulting generated levels will yield higher engagement, create smoother flow and
	better gameplay outcomes, than a comparable stochastic generation method.
	\item RQ1: Can a Genetic Algorithm be used to generate dungeon layouts that achieve a 
	balance between challenge and skill to create good flow in a procedurally generated dungeon crawler?
	\item RQ2: How do procedural generation methods (Genetic Algorithm vs. Reinforcement Learning) 
	interact with player experience, engagement and gameplay outcomes.
\end{itemize}
