...
\subsubsection{About}
Initial iteration was just Antonios Liapis' MiniDungeons project \cite{liapis_minidungeons} ported to Python by ganyariya \cite{GymMd}.
...
\begin{itemize}
	...
	\item Patch \texttt{gym-md} to work with latest version of gymnasium.
