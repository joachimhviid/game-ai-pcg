...
Initial iteration was just Antonios Liapis' MiniDungeons project ported to Python by ganyariya.

Purpose: Baseline proof of concept that the project works.

Work:  
\begin{itemize}
	\item Setup poetry project.
	\item Patch \texttt{gym\_md} to work with latest version of gymnasium.
	\item Ensure we are able to run custom maps.
\end{itemize}
...
Work:
\begin{itemize}
	\item Recreated \texttt{gym\_md} environment and moved rendering to pygame.
