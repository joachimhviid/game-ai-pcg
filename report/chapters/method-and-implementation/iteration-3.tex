...
The test was performed on a standard desktop PC, utilizing the MiniDungeons environment to simulate play-throughs.
...
However, we observed that "fitness" does not always equal "fun" in a subjective sense.
...
With the generator functional, that concludes the 3rd iteration.
