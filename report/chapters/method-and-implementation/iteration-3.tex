...
The next step would be to implement PPO training for a more sophisticated agent, which could better evaluate the levels and provide a more nuanced fitness function.
