...
Figures and tables should be only at the top and bottom of columns. Avoid placing them in the middle of columns. Large figures and tables may span 
across both columns. Figure captions should be below the figures; table heads should appear above the tables. Insert figures and tables after they 
are cited in the text, or at most on the same page. Use the abbreviation “Fig. \ref{fig}”, even at the beginning of a sentence. 

Remember that you can use labels and the \textbackslash ref command to have LaTeX update the number automatically if you move figures/tables around. 
See the previous paragraph (in the code) for an example.
